...
namespace Test
{
    ...
    public class Game1 : Game
    {
        ...
        Riddlersoft.Graphics.Tiles.TileRender tr;
        ...
        protected override void LoadContent()
        {
          ...
          //  text.AddModifyer(ft);
            ...
            Riddlersoft.Graphics.Tiles.TileRender.SetTextures("", "", "tile1@2", "");
            Riddlersoft.Graphics.Tiles.TileRender.UpdateTextureTexture(Riddlersoft.Graphics.Config.TextureResolution._2k, Content);

            tr = new Riddlersoft.Graphics.Tiles.TileRender(new List<Point>() { new Point(0, 0) }, Vector2.Zero, 0, false);
            tr.UpdateTextureResolution(Vector2.Zero, 160);
        }
